...
export function buttonClassName(props: ButtonProps): string {
    ...
    return "flex justify-center items-center gap-2 h-10 text-neutral-500 hover:text-neutral-900 rounded-full transition-all"
        + (hasShadow ? " shadow-outset dark:shadow-outsetDark hover:shadow-outset dark:shadow-outsetDarkHover bg-white dark:bg-neutral-100" : " hover:bg-neutral-100")
        // + (hasShadow ? " relative bg-white after:absolute after:inset-0 after:-z-10 after:bg-gradient-to-r after:from-green-400 after:to-green-600 after:blur-sm after:rounded-full after:opacity-0 hover:after:opacity-40 hover:focus:after:opacity-50 after:transition-all after:duration-200 hover:shadow-outset dark:shadow-outsetDarkHover" : "")
        // + (hasShadow ? " shadow-outset dark:shadow-outsetDark dark:bg-neutral-100" : " hover:bg-neutral-100 dark:hover:bg-neutral-200") //TODO: figure out how to get dark to work for nightwind and not system
