...
export function rawToHistoryEntry(raw: RawHistoryEntry): HistoryEntry | undefined {
    ...
    return {
        ...
        startReason: (raw.reason_start !== undefined) ? StartReason[raw.reason_start!] : StartReason.Unknown,
        endReason: (raw.reason_end !== undefined) ? EndReason[raw.reason_end!] : EndReason.Unknown,
        shuffle: raw.shuffle,
        skipped: raw.skipped,
        offline: raw.offline,
    }
